...
def zone_get(
    hetzner_dns_token=None, zone_id=None, name=None, zone_name=None, id_only=False
):
    """
    ...
    * hetzner_dns_token *MUST* be passed in args or as environment
    ...
    if (name is None and os.environ.get("NAME")) or (
        zone_name is None and os.environ.get("ZONE_NAME")
    ):
