...
def record_delete(
    ...
    * hetzner_dns_token *MUST* be passed in args or as environment
    ...
    if not delete_multiple_records and os.environ.get("DELETE_MULTIPLE_RECORDS"):
    ...
    if not record_id:
        ...
        record_get_id_result = record_get(
        ...
        if type(record_get_id_result) == list:
            ...
            if not delete_multiple_records:
                error_message = (
                    f"Found {records_count} records. To "
